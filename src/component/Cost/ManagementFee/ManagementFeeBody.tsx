...
import ManagementFeeBodyRow from "./ManagementFeeBodyRow";

const useStyles = makeStyles(theme => ({}));

export interface ManagementFeeBodyProps {}

const ManagementFeeBody: React.FC<ManagementFeeBodyProps> = () => {
...
export default ManagementFeeBody;
