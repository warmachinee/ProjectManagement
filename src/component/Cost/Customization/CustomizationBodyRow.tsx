...
export interface CustomizationBodyRowProps {}
...
const CustomizationBodyRow: React.FC<CustomizationBodyRowProps | any> = ({
  itemIndex,
  data,
  moveTask,
  movingItem
  ...
  function detectChange() {
    ...
    for (let i in values) {
      const val =
        i === "content" || i === "educational" || i === "experience"
          ? values[i]
          : _checkIsNaN(values[i], 0);
      if (val !== data[i]) {
...
export default CustomizationBodyRow;
