...
import CustomizationBodyRow from "./CustomizationBodyRow";

const useStyles = makeStyles(theme => ({}));

export interface CustomizationBodyProps {}

const CustomizationBody: React.FC<CustomizationBodyProps> = () => {
    ...
    <TableBody>
      {costData && (
        <React.Fragment>
          ...
          <TableRow>
            <TableCell colSpan={2} />
            <TableCell style={{ fontWeight: 900 }} colSpan={6}>
              Total
            </TableCell>
...
export default CustomizationBody;
